...
const EditProfile = () => {
  ...
  const [avatarPreview, setAvatarPreview] = useState(
    user.avatar.url || "https://i.pravatar.cc/150?imag3"
  );
  ...
  return (
    <Fragment>
      <div className="row wrapper">
        <div className="col-10 clo-lg-5 updateprofile">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              form.handleSubmit();
            }}
            encType="multipart/form-datra"
          >
            ...
            <form.Field name="avatar">
              {(field) => (
                <div className="form-group">
                  <label htmlFor="avatar_upload">Name</label>
